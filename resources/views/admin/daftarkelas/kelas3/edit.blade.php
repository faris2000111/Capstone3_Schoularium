...
@section('title', 'Edit Kelas - 3 - Schoularium')
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Edit Data Kelas 3</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('daftar-kelas.index') }}">Daftar Kelas 3</a></li>
                <li class="breadcrumb-item active">Edit Kelas 3</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
