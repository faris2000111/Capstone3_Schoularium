...
@section('title', 'Edit Kelas 2 - Schoularium')
...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Edit Data Kelas 2</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('daftar-kelas.index') }}">Daftar Kelas 2</a></li>
                <li class="breadcrumb-item active">Edit Kelas 2</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
