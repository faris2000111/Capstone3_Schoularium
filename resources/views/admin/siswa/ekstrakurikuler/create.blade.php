      ...
      <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- Multi Columns Form -->
            <form class="row g-3" action="{{ route('ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="col-md-12">
                <label for="nama_ekstrakurikuler" class="form-label">nama_ekstrakurikuler</label>
                <input type="text" class="form-control" id="nama_ekstrakurikuler" placeholder="Masukkan nama_ekstrakurikuler Siswa" name="nama_ekstrakurikuler" value="{{ old('nama_ekstrakurikuler') }}">
              </div>
              <div class="col-md-12">
