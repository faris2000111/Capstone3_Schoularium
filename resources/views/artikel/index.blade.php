...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <td>{{ $artikel->kategori ? $artikel->kategori->deskripsi : 'Tidak Ada Kategori' }}</td>
        <td>{{ $artikel->judul }}</td>
        <td>{{ $artikel->deskripsi ?? 'Deskripsi Tidak Tersedia' }}</td>
        
                                <td>
                                    <a href="{{ route('editArtikel', ['id' => $artikel->id]) }}" class="btn btn-warning btn-sm" role="button">Edit</a>
                                    <a onclick="confirmDelete(this)"
                                        data-url="{{ route('deleteArtikel', ['id' => $artikel->id]) }}" class="btn btn-danger btn-sm" role="button">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
